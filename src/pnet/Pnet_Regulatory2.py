...
from pnet import ReactomeNetwork_2Regulatory, pnet_loader, util
...
class PNET_NN(pl.LightningModule):
    def __init__(
        ...
        fcnn=False,
        loss_weight=None,
        aux_loss_weights=[15, 2, 7, 20, 54, 148, 400],
    ):
        super().__init__()
        ...
        self.preds.append(
            nn.Sequential(
                *[
                    nn.Linear(
                        in_features=self.extra_mask.shape[1] + self.additional_dims,
